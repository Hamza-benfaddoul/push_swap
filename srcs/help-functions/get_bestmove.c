...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/12 16:27:57 by hbenfadd          #+#    #+#             */
/*   Updated: 2023/01/17 09:37:51 by hbenfadd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static int	get_indexmaxnbr(int *arry, size_t size)
{
	size_t	i;
	int		tmp;
	size_t	index;
...
static int	get_position(int *arry, int *nbr, size_t size)
{
	int	i;
	int	j;
...
static int	*initialize_move(int *arry, void *ptr, size_t size_a)
{
	int	*move;
